...
public class Admin extends HttpServlet {
    ...
    private void validateLogin(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        if ("root".equals(id) && pass.equals(pwd)) {
            ...
            try (Connection con = getConnection(); 
                ...
                resp.sendError(500, "Error creating tables:" + e.getMessage());
            }
    ...
    private void createTables(Statement stmt) throws SQLException {
        stmt.executeUpdate("CREATE TABLE IF NOT EXISTS login (name VARCHAR(20), addr VARCHAR(20), phno VARCHAR(10), id VARCHAR(20) PRIMARY KEY, pwd VARCHAR(20))");
        stmt.executeUpdate("CREATE TABLE IF NOT EXISTS books (title VARCHAR(20), author VARCHAR(20), version VARCHAR(20), publisher VARCHAR(20), cost INT(10))");
        stmt.executeUpdate("CREATE TABLE IF NOT EXISTS details (id VARCHAR(20), title VARCHAR(20), amount INT(10), cno VARCHAR(12))");
    }
    ...
    private void viewPurchases(HttpServletResponse resp) throws IOException {
        ...
        out.println("<html><head><link rel='stylesheet' type='text/css' href='static/style.css'></head><body>");
    ...
    private Connection getConnection() throws ClassNotFoundException, SQLException {
        ...
        return DriverManager.getConnection("jdbc:mysql://mysqldb:3306/mydb", "root", pass);
    }
}